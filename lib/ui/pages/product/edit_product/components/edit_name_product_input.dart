...
class EditNameProductInput extends StatelessWidget {
  final ProductEditPresenter presenter;
  final String name;
  const EditNameProductInput(this.presenter, this.name, {super.key});
        ...
        builder: (context, snapshot) {
          return TextFormField(
            ...
            decoration: InputDecoration(
              ...
              labelText: FlutterI18n.translate(context, 'create-product.name'),
