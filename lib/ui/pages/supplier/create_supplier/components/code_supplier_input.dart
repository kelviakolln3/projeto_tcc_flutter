...
class CodeSupplierInput extends StatelessWidget {
  final SupplierCreatePresenter presenter;
  const CodeSupplierInput(this.presenter, {super.key});
        ...
        builder: (context, snapshot) {
          return TextFormField(
            ...
            decoration: InputDecoration(
              ...
              labelText: FlutterI18n.translate(context, 'create-supplier.code'),
