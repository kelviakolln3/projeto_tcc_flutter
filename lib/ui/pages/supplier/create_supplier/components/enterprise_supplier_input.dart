...
class EnterpriseSupplierInput extends StatelessWidget {
  final SupplierCreatePresenter presenter;
  const EnterpriseSupplierInput(this.presenter, {super.key});
        ...
        builder: (context, snapshot) {
          return TextFormField(
            ...
            decoration: InputDecoration(
              ...
              labelText: FlutterI18n.translate(context, 'create-supplier.enterprise'),
