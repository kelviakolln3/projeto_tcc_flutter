...
class EditEnterpriseSupplierInput extends StatelessWidget {
  final SupplierEditPresenter presenter;
  final String enterprise;
  const EditEnterpriseSupplierInput(this.presenter, this.enterprise, {super.key});
      ...
      child: StreamBuilder<String?>(
        ...
        builder: (context, snapshot) {
          return TextFormField(
            ...
            onChanged: presenter.validateEnterprise,
            ...
            decoration: InputDecoration(
              ...
              labelText: FlutterI18n.translate(context, 'edit-supplier.enterprise'),
