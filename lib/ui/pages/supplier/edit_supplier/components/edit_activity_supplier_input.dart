...
class EditActivitySupplierInput extends StatelessWidget {
  final SupplierEditPresenter presenter;
  final String activity;
  const EditActivitySupplierInput(this.presenter, this.activity, {super.key});
        ...
        builder: (context, snapshot) {
          return TextFormField(
            ...
            decoration: InputDecoration(
              ...
              labelText: FlutterI18n.translate(context, 'edit-supplier.activity'),
